...
export function ExpedienteFormDialog({
  ...
  const action = expediente
    ? updateExpediente.bind(null, expediente.id)
    : createExpediente;
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <Input
                id="number"
                name="number"
                defaultValue={expediente?.number ?? ""}
              />
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <Input
                id="ownerTaxId"
                name="ownerTaxId"
                defaultValue={expediente?.ownerTaxId ?? ""}
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className={selectClass}
              >
                {Object.entries(EXPEDIENTE_STATUS_LABEL).map(
                  ([value, label]) => (
